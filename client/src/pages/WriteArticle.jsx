...
import { Edit, Sparkles, Crown, Copy, Zap, Clock, FileText, Loader, CheckCircle } from 'lucide-react';
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl border border-yellow-500/20 p-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h2 className="text-sm font-semibold text-white">Article Topic</h2>
                  <p className="text-xs text-gray-400">What to write about?</p>
                </div>
              </div>
              <input
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl border border-yellow-500/20 p-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h2 className="text-sm font-semibold text-white">Article Length</h2>
                  <p className="text-xs text-gray-400">Choose length</p>
                </div>
              </div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className={`w-2 h-2 rounded-full ${
                        selectedLength.text === item.text ? 'bg-yellow-400' : 'bg-gray-400'
                      }`}></div>
                      <div>
                        <h3 className={`text-sm font-medium ${
                          selectedLength.text === item.text ? 'text-yellow-300' : 'text-white'
                        }`}>
                          {item.text}
                        </h3>
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl border border-yellow-500/20 p-4">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-sm font-semibold text-white">Generated Article</h2>
            ...
            {loading ? (
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">Creating Your Article</h3>
                <p className="text-sm text-gray-400 mb-4">We are generating your article, please wait...</p>
              ...
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <h3 className="text-sm font-semibold text-white mb-2">No Article Generated</h3>
                <p className="text-xs text-gray-400 text-center max-w-xs">
                  Enter your topic, select length, and generate your article.
                </p>
              </div>
            ) : (
              <div className="max-h-[500px] overflow-y-auto">
                ...
                <div className="mt-3 grid grid-cols-3 gap-2">
                  ...
                  <div className="text-center p-2 bg-gray-700/30 rounded border border-gray-600/30">
                    <div className="text-sm font-bold text-yellow-400">{selectedLength.text}</div>
